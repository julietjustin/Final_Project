...
public class WaitUtility {
	...
	public static void waitVisibilityOfAllElementsLocatedBy(WebDriver driver,WebElement elements) {
		WebDriverWait wait=new WebDriverWait(driver,Duration.ofSeconds(EXPLICIT_WAIT));
	...
	public static void staleElement(WebDriver driver,WebElement element) {
		WebDriverWait wait=new WebDriverWait(driver,Duration.ofSeconds(EXPLICIT_WAIT));
	...
	public static void fluentStale(WebDriver driver,WebElement elements) {
		Wait<WebDriver>fluentWait=new FluentWait<WebDriver>(driver)
				.withTimeout(Duration.ofSeconds(FLUENT_WAIT))
				.pollingEvery(Duration.ofSeconds(POLLING_TIME))
				.ignoring(NoSuchElementException.class);
		fluentWait.until(ExpectedConditions.stalenessOf(elements));
	}
